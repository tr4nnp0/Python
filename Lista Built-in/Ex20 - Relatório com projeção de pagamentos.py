...
aqueles funcionários cujo salário for muito baixo, recebem este valor mínimo; Neste momento, não se deve ter nenhuma preocupação
com colaboradores com tempo menor de casa, descontos, impostos ou outras particularidades. Seu programa deverá permitir a digitação
do salário de um número indefinido (desconhecido) de salários. Um valor de salário igual a 0 (zero) encerra a digitação. Após a entrada
de todos os dados o programa deverá calcular o valor do abono concedido a cada colaborador, de acordo com a regra definida acima.
...
while valor > 0:
    valor = int(input("Digite o valor do salário do funcionário: "))
    if valor <= 100:
        abono_minimo += 1
        salarios.append(100)
        abonos.append(20)
...
print("Projeção de Gastos do Abono")
print("===========================")
...
print(f"Valor mínimo pago a {abono_minimo} colaboradores")
